...
const Hero = () => {
  return (
    <div className='text-white relative'>
        <img src={HeroBg} alt="background-image" className='w-full rounded-2xl h-[400px] object-center object-cover' />
        ...
        <div className='flex space-x-2 md:space-x-4 absolute bottom-3 left-4 md:bottom-8 md:left-10 font-medium'>
            ...
            <button className='flex justify-center items-center bg-[#e50914] hover:bg-gray-200 hover:text-black text-white py-3 px-4 rounded-full cursor-pointer text-sm md:text-base'>
